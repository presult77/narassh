...
Documentation=https://naravpn.com
...
ExecStart=/etc/slowdns/sldns-client -udp 8.8.8.8:53 --pubkey-file /etc/slowdns/server.pub dns-$nameserver 127.0.0.1:3369
Restart=on-failure
...
AmbientCapabilities=CAP_NET_ADMIN CAP_NET_BIND_SERVICE
NoNewPrivileges=true
ExecStart=/etc/slowdns/sldns-server -udp :5300 -privkey-file /etc/slowdns/server.key dns-$nameserver 127.0.0.1:2269
Restart=on-failure
